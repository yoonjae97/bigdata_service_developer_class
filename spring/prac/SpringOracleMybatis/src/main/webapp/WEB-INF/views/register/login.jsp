...
<main>
	<h1>로그인 폼</h1>
	<form method="post" action="<%=request.getContextPath() %>/register/loginOk" onsubmit="return logChk()"> <!-- logChk return값에 return을 해서 onsubmit에 값 전달 -->
		<ul>
			...
			<li>
				...
				<div><a href="<%=request.getContextPath() %>/register/regForm">회원가입</a></div>
			</li>
		</ul>
	</form>
</main>